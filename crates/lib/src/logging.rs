...
/// Initialize CLI-style logging: program output goes to stdout; all log
/// output goes to stderr so the two streams can be separated (e.g. piping
/// JSON while watching logs).
